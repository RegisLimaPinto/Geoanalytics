"""
Rotas de pagamento — MercadoPago (análise avulsa).

Fluxo:
  1. POST /api/payments/checkout  → cria preference no MP → retorna init_point (URL de pagamento)
  2. Usuário paga no MP
  3. MP chama POST /api/payments/webhook com o resultado
  4. Webhook aprova → credita 1 análise na conta do usuário
"""
import hashlib
import hmac
import os
